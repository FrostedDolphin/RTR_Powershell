#Desc: List all named pipes and owning process on the system

<# Get-ProcessPipes 

    Gets all named pipes and owning process on a system
    Use with -CSV to export to CSV file
